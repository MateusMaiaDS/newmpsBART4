...
void Node::updateNodeLogLike(modelParam& data){
        ...
        for(int k = 0; k < data.d_var;k++){
                ...
                // if(ancestors(k)>0){ //Adding all ancestors
...
void updateBeta(Node* tree, modelParam &data){
        ...
        for(int i = 0; i < t_nodes.size();i++){
                ...
                for(int j=0;j<data.d_var;j++){
                        ...
                        // if(t_nodes[i]->ancestors(j)>0){ // Always updating all predictors
                        ...
                        // ====== THIS ELSE IS COMMENTED TO UPDATE ALL VARIABELS ===== //
                        // } else {
...
void updateGamma(Node* tree, modelParam &data){
        ...
        for(int i = 0; i < t_nodes.size();i++){
                ...
                for(int j = 0; j<data.d_var;j++){
                        // Using all variables regardless if a tree was used to split or not
